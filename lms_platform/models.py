...
class Course(models.Model):
    ...
    # price = models.DecimalField(max_digits=20, decimal_places=3, verbose_name='Стоимость курса', **NULLABLE)
...
class Lesson(models.Model):
    ...
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, blank=True, null=True)  # Пользователь
    # price = models.DecimalField(max_digits=20, decimal_places=3, verbose_name='Стоимость урока', **NULLABLE)
